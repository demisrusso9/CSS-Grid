...
import '../../assets/css/sections/Populares.css'
...
export default () =>
    <section class="populares">
        <div class="populares__itens">
            ...
            <div class="populares__conteudo">
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/slack.png")} />
                    <div class="populares__card___corpo">
                        ...
                        <div class="populares__card___descricao">
                            ...
                            como uma ferramenta interna usada por sua empresa, Tiny Speck, no desenvolvimento do Glitch,
                            um jogo online agora extinto.
                        </div>
                    </div>
                </div>

                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/whatsapp.png")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
                        ...
                        <div class="populares__card___descricao">
                            ...
                            smartphones. Além de mensagens de texto, os usuários podem enviar imagens, vídeos e
                ...
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require('../../assets/img/telegram.jpeg')} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
                ...
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/trello.jpg")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
                        ...
                        <div class="populares__card___descricao">
                            Trello é um aplicativo de gerenciamento de projeto baseado na web originalmente feito por
                            Fog Creek Software em 2011. Em 2014 tornou-se uma empresa. Ele opera um modelo de negócio
                            Freemium, no qual é disponibilizado a versão gratuita ou paga para o usuário.
                        </div>
                    </div>
                </div>

                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/skype.png")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
        ...
        <div class="populares__itens">
            ...
            <div class="populares__conteudo">
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/fortnite.jpg")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
                ...
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/pubg.jpg")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
                        ...
                        <div class="populares__card___descricao">
                            ...
                            desenvolvido pela PUBG Corp., subsidiária da produtora coreana Bluehole, utilizando o motor
                ...
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/cs-go.jpg")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
                ...
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/lol.jpg")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
                        ...
                        <div class="populares__card___descricao">
                            ...
                            gratuito para jogar e inspirado no modo Defense of the Ancients de Warcraft III: The Frozen
                            Throne.
                        </div>
                    </div>
                </div>
                ...
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/gta-v.jpg")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
        ...
        <div class="populares__itens">
            ...
            <div class="populares__conteudo">
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/brawl-stars.jpg")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
                        ...
                        <div class="populares__card___descricao">
                            ...
                            desenvolvido e publicado pela Supercell. Em 14 de junho de 2017, a Supercell anunciou o jogo
                ...
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/organizze.jpeg")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
                        ...
                        <div class="populares__card___descricao">
                            Usado por mais de 1 milhão de pessoas, o Organizze é uma ferramenta online que vai facilitar
                            sua vida financeira.
                        </div>
                    </div>
                </div>
                ...
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/onefotball.jpeg")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
                        ...
                        <div class="populares__card___descricao">
                            Onefootball é a melhor plataforma para os fãs de futebol de todo o mundo. Das notícias às
                            pontuações e estatísticas - Contamos as histórias de futebol do mundo, trazidas a você por
                ...
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/free-fire.jpg")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
                ...
                <div class="populares__card">
                    <img class="populares__card___imagem" src={require("../../assets/img/mario-kart.jpg")} />
                    <div class="populares__card___corpo">
                        <div class="populares__card___cabecalho">
